  ...
  return (
    <main className="page">
      ...
      <header className="header">
        <Link className="brand" href="/" aria-label="PKC BIZOFT home">
      ...
      <section className="hero" id="home">
        ...
        >
          ...
          <div className="earthFrame" aria-hidden="true">
            <span className="earthFrameInner" />
          </div>
      ...
      <style jsx>{`
        ...
        .hero {
          ...
          grid-template-columns:
            minmax(300px, 0.86fr) minmax(480px, 1.28fr)
            minmax(330px, 0.8fr);
          align-items: center;
          gap: 30px;
          padding: 42px 0 48px;
        ...
        .earthFrame {
          ...
          border-radius: 50%;
          box-shadow:
            0 0 0 18px rgba(103, 232, 249, 0.018),
            0 0 45px rgba(0, 190, 225, 0.1),
            inset 0 0 35px rgba(0, 180, 215, 0.035);
          pointer-events: none;
        }
        .earthFrame::before {
          content: "";
          position: absolute;
          inset: 11px;
          border: 1px dashed rgba(103, 232, 249, 0.07);
          border-radius: 50%;
        }
        .earthFrameInner {
          position: absolute;
          inset: -14px;
          border: 1px solid rgba(103, 232, 249, 0.045);
          border-radius: 50%;
        }
        .globeStage {
          position: relative;
