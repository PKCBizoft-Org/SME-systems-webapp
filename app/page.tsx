...
const APP_DOWNLOAD_URL =
  "https://github.com/pkcbizoft26gh/pkc-bizoft-mobile/releases/latest/download/app-debug.apk";
    ...
    <main className={`page ${introVisible ? "hasIntro" : "introComplete"}`}>
      ...
      <nav className="nav">
        ...
        <div className="navRight">
          ...
          <a className="appButton" href={APP_DOWNLOAD_URL} download>
        ...
        <div className={`mobileMenu ${mobileMenuOpen ? "open" : ""}`}>
          ...
          <a href={APP_DOWNLOAD_URL} download onClick={() => setMobileMenuOpen(false)}>GET THE APP <b>⇩</b></a>
      ...
      <style jsx>{`
        ...
        .appButton {
          ...
          gap: 8px;
          padding: 10px 14px;
          border: 1px solid rgba(76, 239, 192, 0.32);
          background: rgba(24, 51, 44, 0.35);
          color: rgba(220, 255, 244, 0.85);
          font-size: 10px;
          font-weight: 700;
        ...
        .appButton em {
          ...
          padding: 3px 6px;
          border-radius: 3px;
          background: rgba(76, 239, 192, 0.14);
          color: #4cefc0;
          font-size: 8px;
        ...
        .appButton:hover {
          transform: translateY(-2px);
          border-color: rgba(76, 239, 192, 0.65);
          box-shadow: 0 10px 30px rgba(76, 239, 192, 0.15);
          color: #eafff8;
        }
